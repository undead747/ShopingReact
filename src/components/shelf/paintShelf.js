...
import {fetchPaintProducts} from '../../actions/paintActions';
...
class Shelf extends Component {
  ...
  componentWillMount() {
    const { filters, sort,checkfilter} = this.props;
      ...
      this.props.fetchPaintProducts(filters, sort,checkfilter);
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextFilters !== this.props.filters) {
      this.props.fetchPaintProducts(nextFilters, undefined,undefined);
    }

    if (nextSort !== this.props.sort) {
      this.props.fetchPaintProducts(undefined, nextSort,undefined);
    }
    if(nextcheckfilter !== this.props.checkfilter){
      this.props.fetchPaintProducts(undefined,undefined,nextcheckfilter);
    }
  }
...
export default connect (mapStateToProps,{fetchPaintProducts, addProduct })(Shelf);
